...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>EducaSinal - Aprenda Língua Gestual</title>
        <meta name="description" content="Aprenda Língua Gestual Portuguesa de forma fácil e acessível com o EducaSinal." />
      </Head>
